...
namespace EAddonsForElementor\Overrides;
/*
 * Credits to Wordpress WP_Query class
 * 
 ...
 * @since 4.7.0
 */
class E_Query extends \WP_Query {
    ...
    public function get_posts() {
        ...
        if ($this->is_tax) {
            if (empty($post_type)) {
                ...
                //foreach ( get_post_types( array( 'exclude_from_search' => false ) ) as $pt ) { // FRA
        ...
        if ('any' == $post_type) {
            //$in_search_post_types = get_post_types( array( 'exclude_from_search' => false ) ); // FRA
