...
trait Items_Content {
        ...
        */
            ...
            if($type == 'post'){
                ...
                $target->add_control(
                    'textcontent_limit', [
                        ...
                        'type' => Controls_Manager::NUMBER,
                        'description' => __('Empty it\'s all.','e-addons'),
                        'default' => '',
                        'conditions' => [
                            'terms' => [
                                [
        ...
        public function controls_items_authorbox_content( $target ) {
            ...
            $target->add_control(
                'author_image', [
                    'label' => __('Show avatar image', 'e-addons'),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes',
                    'conditions' => [
                        'terms' => [
            ...
            $target->add_control(
                'author_user_key',
                [
                    'label' => __('User Key', 'e-addons'),
                    'type'      => 'e-query',
                    'placeholder'   => __( 'Field key or Name', 'e-addons' ),
                    'label_block'   => true,
                    'multiple'      => true,
                    'separator'     => 'after',
                    'query_type'    => 'fields',
        ...
        public function controls_items_posttype_content( $target ) {
            $target->add_control(
                'posttype_label', [
                    'label' => __('Label of post type', 'e-addons'),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'plural',
                    'options' => [
        ...
        public function controls_items_taxonomy_content( $target ) {
            $target->add_control(
                'taxonomy_label', [
                    'label' => __('Label of Taxonomy', 'e-addons'),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'plural',
                    'options' => [
                        'plural' => __('Plural', 'e-addons'),
        ...
        public function controls_items_imagemeta_content( $target ) {
            $target->add_control(
                'imagemedia_sizes', [
                    'label' => __('Image Size meta', 'e-addons'),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'full',
            ...
            $target->add_control(
                'imagemedia_metas', [
                    'label' => __('Show Metas', 'e-addons'),
                    'type' => Controls_Manager::SELECT2,
                    'multiple' => true,
                    'place_holder' => 'Select metas',
                    'default' => ['dimension'],
                    'options' => [
                        'dimension' => 'Dimension',
                        'file' => 'File name',
